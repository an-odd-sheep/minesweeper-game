...
class LeaderTree
{
    ...
    void inOrder(Node node, int minesCount)
    {
        ...
        {
            System.out.println("Username: " + String.format("%-15s", node.userName) + "\tTiles: " + String.format("%-4d", node.tilesClicked));
        }
...
public class Minesweeper
{
    ...
    void countMines(int row, int column)
    {
        ...
        int numMines = 0;
        numMines += checkMine(row - 1, column - 1); // top-left
        numMines += checkMine(row - 1, column); // top-center
        numMines += checkMine(row - 1, column + 1); // top-right
        numMines += checkMine(row, column - 1); // left
        numMines += checkMine(row, column + 1); // right
        numMines += checkMine(row + 1, column - 1); // bottom-left
        numMines += checkMine(row + 1, column); // bottom-center
        numMines += checkMine(row + 1, column + 1); // bottom-right
        ...
        else
        {
            ...
            countMines(row - 1, column - 1); // top-left
            countMines(row - 1, column); // top-center
            countMines(row - 1, column + 1); // top-right
            countMines(row, column - 1); // left
            countMines(row, column + 1); // right
            countMines(row + 1, column - 1); // bottom-left
            countMines(row + 1, column); // bottom-center
            countMines(row + 1, column + 1); // bottom-right
        }
